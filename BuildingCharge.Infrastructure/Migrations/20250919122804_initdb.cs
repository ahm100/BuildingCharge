    ...
    public partial class initdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitChargeShares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitChargeShares_Charges_ChargeId",
                        column: x => x.ChargeId,
                        principalTable: "Charges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UnitChargeShares_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitChargeShares_ChargeId",
                table: "UnitChargeShares",
                column: "ChargeId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitChargeShares_UnitId",
                table: "UnitChargeShares",
                column: "UnitId");
        }
